...
<head runat="server">
    <meta charset="utf-8" />
    <title>Panel Admin - Tienda de Celulares</title>
    <style>
...
<div class="contenedor">
    ...
    <div class="form-grid">
        <div class="form-campo"><label>Marca:</label><asp:TextBox ID="TxtMarca" runat="server"></asp:TextBox></div>
        <div class="form-campo"><label>Modelo:</label><asp:TextBox ID="TxtModelo" runat="server"></asp:TextBox></div>
        <div class="form-campo"><label>IMEI:</label><asp:TextBox ID="TxtIMEI" runat="server" MaxLength="15"></asp:TextBox></div>
        <div class="form-campo"><label>Almacenamiento:</label><asp:TextBox ID="TxtAlmac" runat="server" placeholder="128GB"></asp:TextBox></div>
        <div class="form-campo"><label>RAM:</label><asp:TextBox ID="TxtRAM" runat="server" placeholder="8GB"></asp:TextBox></div>
        <div class="form-campo"><label>Año Fabricación:</label><asp:TextBox ID="TxtAno" runat="server" placeholder="2024"></asp:TextBox></div>
        <div class="form-campo"><label>Versión SO:</label><asp:TextBox ID="TxtSO" runat="server" placeholder="Android 14"></asp:TextBox></div>
        <div class="form-campo"><label>Banda:</label><asp:TextBox ID="TxtBanda" runat="server" placeholder="5G / 4G LTE"></asp:TextBox></div>
        <div class="form-campo"><label>Descripción:</label><asp:TextBox ID="TxtDescripcion" runat="server"></asp:TextBox></div>
        <div class="form-campo"><label>Categoría:</label><asp:DropDownList ID="DdlCategoria" runat="server" DataTextField="nombre_categoria" DataValueField="id_categoria"></asp:DropDownList></div>
        <div class="form-campo"><label>Proveedor:</label><asp:DropDownList ID="DdlProveedor" runat="server" DataTextField="nombre_empresa" DataValueField="id_proveedor"></asp:DropDownList></div>
        <div class="form-campo"><label>Precio:</label><asp:TextBox ID="TxtPrecio" runat="server"></asp:TextBox></div>
        <div class="form-campo"><label>Stock Inicial:</label><asp:TextBox ID="TxtStock" runat="server"></asp:TextBox></div>
        <div class="form-campo"><label>Imagen:</label><asp:FileUpload ID="FuImagen" runat="server"/></div>
    </div>
    <asp:Button ID="BtnCrearCel" runat="server" Text="CREAR CELULAR" CssClass="btn-crear" OnClick="BtnCrearCel_Click"/>
    ...
    <div class="form-grid">
        ...
        <div class="form-campo"><label>Correo:</label><asp:TextBox ID="TxtProvCorreo" runat="server"></asp:TextBox></div>
        <div class="form-campo"><label>Dirección:</label><asp:TextBox ID="TxtProvDir" runat="server"></asp:TextBox></div>
    </div>
    <asp:Button ID="BtnCrearProv" runat="server" Text="REGISTRAR PROVEEDOR" CssClass="btn-crear" OnClick="BtnCrearProv_Click"/>
    ...
    <div class="form-grid">
        ...
        <div class="form-campo"><label>Cantidad:</label><asp:TextBox ID="TxtMovCantidad" runat="server"></asp:TextBox></div>
        <div class="form-campo"><label>Motivo:</label><asp:TextBox ID="TxtMovMotivo" runat="server"></asp:TextBox></div>
    </div>
    <asp:Button ID="BtnRegistrarMov" runat="server" Text="REGISTRAR MOVIMIENTO" CssClass="btn-crear" OnClick="BtnRegistrarMov_Click"/>
    <br/><br/>
